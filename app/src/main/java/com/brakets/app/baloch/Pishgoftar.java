...
public class Pishgoftar extends AppCompatActivity {
  private Toolbar toolbar;

  @Override
  protected void onCreate(Bundle savedInstanceState) {
    super.onCreate(savedInstanceState);
    setContentView(R.layout.activity_pishgoftar);
    ...
    txtmatn.setText(Html.fromHtml(getString(R.string.pishgoftar)));
